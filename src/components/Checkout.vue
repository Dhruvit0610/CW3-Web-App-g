<template>
    ...
    <div>
      <h1 class="text-center"> Checkout Page </h1>
        <!-- <h2 class="text-center"> Total Card Items : </h2> -->
        <h2 class="text-center">{{ totalItemsInBasket }} Total Card Items</h2>
        <b-container class="bv-example-row mt-3">
            <b-row>
                <b-col v-for="product in basket">
                    <b-card :title="product.title" v-bind:img-src="product.img" img-top style="max-width: 150px"
